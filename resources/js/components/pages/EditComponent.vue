      ...
      <div class="container">
        ...
        <form @submit.prevent="update()">
          ...
          <div class="form-group">
            <input type="title" ref="name" v-model="page.name" class="form-control" id="name" placeholder="Enter title" required>
          </div>
...
<script>
import {PAGE_EDIT, GET_PAGE_ID,PAGE_RESET_STATE} from '../store/actions/page';
 ...
 export default {
      ...
      methods: {
        update() {
          ...
          this.$store.dispatch(PAGE_EDIT,{slug:this.postId,formdata:formData}).then(( {data} ) => {
