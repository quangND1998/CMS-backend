...
import {FETCH_PAGES ,PAGE_PUBLISH,PAGE_DELETE,PAGE_EDIT ,GET_PAGE_ID,PAGE_RESET_STATE} from '../actions/page'
import { FETCH_START, FETCH_END, FETCH_ID_PAGE, RESET_STATE } from '../muntation/page'
...
export const actions = {
  ...
  [GET_PAGE_ID]( { commit }, slug) {
      ...
      // console.log(slug);
      return pageService.getbyid(slug).then(({ data }) => {
