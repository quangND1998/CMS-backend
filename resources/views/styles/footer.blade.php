<section id="{{Str::of($section->text)->slug('-')}}" class="bg-dark text-white">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 ml-auto mr-auto text-center wow fadeInUp">

                @if (Config::get('app.locale') == 'vn')
                    <h2 class="text-white text-uppercase">{{ $section->title_vn }}</h2>
                    <p>{{ $section->sub_title_vn }}
                @endif
                @if (Config::get('app.locale') == 'en')
                    <h2 class="text-white text-uppercase">{{ $section->title }}</h2>
                    <p>{{ $section->sub_title }}
                @endif
